...
func NewLocalVPNStatusCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, arguments []string) error {
			...
			if args.NetbirdToken != "" {
				...
				tmpstate, err := state.GetState(shared.StatePath)
				if err != nil {
	...
	addVPNStatusArgs(cmd.Flags())
	return cmd
}

func init() {
	localVPNCmd.AddCommand(NewLocalVPNStatusCmd())
}

func addVPNStatusArgs(flagset *pflag.FlagSet) {
